...
return array(
    ...
    'content'    => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"margin":{"top":"0","bottom":"0"}},"border":{"top":{"style":"none","width":"0px"},"right":{"style":"none","width":"0px"},"bottom":{"color":"#eeeeee","style":"none","width":"0px"},"left":{"style":"none","width":"0px"}}},"backgroundColor":"bg-prim","layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"accent","style":{"border":{"radius":"100px"},"spacing":{"padding":{"top":"1rem","right":"2rem","bottom":"1rem","left":"2rem"}}},"className":"is-style-fill","fontSize":"normal"} -->
    <div class="wp-block-button has-custom-font-size is-style-fill has-normal-font-size"><a class="wp-block-button__link has-accent-background-color has-background wp-element-button" style="border-radius:100px;padding-top:1rem;padding-right:2rem;padding-bottom:1rem;padding-left:2rem">' . esc_html( $strings['button'] ) . '</a></div>
    <!-- /wp:button --></div>
    <!-- /wp:buttons -->
...
<figure class="wp-block-image aligncenter size-full"><img src="' . esc_url( BLOCKLINE_URL . 'assets/images/').'hero.png" alt="" class="wp-image-13"/></figure>
<!-- /wp:image --></div>
    ',
);
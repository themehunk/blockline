        ...
        <Fragment>
            <div className="option-content-wrp">
               <div className="content-box">
                ...
                <a href="#" className="content-link "> {__( 'Need help ?', 'blockline' )}</a>
               </div>
               <div className="content-box">
                ...
                <a href="#" className="content-link "> {__( 'Go to Doc', 'blockline' )}</a>
               </div>
               <div className="content-box">
                ...
                <a href="#" className="content-link "> {__( 'Create Child Theme', 'blockline' )}</a>
               </div>
               <div className="content-box">
                ...
                <a href="#" className="content-link button"> {__( 'Join Our Facebook Group', 'blockline' )}</a>
               </div>
            </div>
        </Fragment>
    );
